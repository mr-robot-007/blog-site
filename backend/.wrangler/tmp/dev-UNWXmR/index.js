...
// .wrangler/tmp/bundle-6f6JW7/checked-fetch.js
...
// .wrangler/tmp/bundle-6f6JW7/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-6f6JW7/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post("/api/v1/signup", async (c) => {
  const primsa = new import_edge.PrismaClient({
...
app.post("/api/v1/signin", async (c) => {
  ...
  try {
    ...
    return c.text("invalid user info");
  }
});
